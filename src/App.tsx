  ...
  const navItems: { id: NavSection; label: string; icon: React.ReactNode; activeIcon: React.ReactNode; color: string }[] = [
    {
      ...
      activeIcon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
          <path d="M11.25 3.375C11.25 2.754 11.754 2.25 12.375 2.25h-.75C12.246 2.25 12.75 2.754 12.75 3.375V4.5h-.75c-.621 0-1.125.504-1.125 1.125v.75H9.75A2.25 2.25 0 007.5 8.625v.75c0 .414.336.75.75.75h7.5a.75.75 0 00.75-.75v-.75A2.25 2.25 0 0014.25 6.375h-1.125v-.75c0-.621-.504-1.125-1.125-1.125h-.75V3.375zM6 10.5a.75.75 0 00-.75.75v8.25c0 .414.336.75.75.75h12a.75.75 0 00.75-.75V11.25a.75.75 0 00-.75-.75H6z"/>
        </svg>
      ),
    },
    {
