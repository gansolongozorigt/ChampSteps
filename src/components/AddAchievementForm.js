...
function Header({ step, childName, isEditing }) {
    ...
    return (_jsxs("header", { children: [_jsx("p", { className: "text-xs uppercase tracking-widest text-stone-500", children: childName ? t("form.headerEyebrowWithName", { name: childName }) : t("form.headerEyebrow") }), _jsx("h2", { className: "mt-1 font-serif text-2xl text-stone-900", children: isEditing ? t("form.editHeading") : t("form.heading") }), _jsx("ol", { className: "mt-5 flex items-center gap-2", children: labels.map((label, i) => {
                    const idx = (i + 1);
