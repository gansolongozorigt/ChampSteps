...
const FRAME_STYLES = ["classic", "corner", "minimal"];
export default function PdfPreviewModal({ open, onClose, child, achievements, template, includeImages, }) {
    ...
    const fullscreenIcon = (_jsx("svg", { className: "w-4 h-4", fill: "none", viewBox: "0 0 24 24", stroke: "currentColor", strokeWidth: 2, children: _jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", d: "M4 8V4h4M20 8V4h-4M4 16v4h4M20 16v4h-4" }) }));
    const expandIcon = (_jsx("svg", { className: "w-4 h-4", fill: "none", viewBox: "0 0 24 24", stroke: "currentColor", strokeWidth: 2, children: _jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", d: "M15 4h5v5M20 4l-6 6M9 20H4v-5M4 20l6-6" }) }));
    const collapseIcon = (_jsx("svg", { className: "w-4 h-4", fill: "none", viewBox: "0 0 24 24", stroke: "currentColor", strokeWidth: 2, children: _jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", d: "M14 10h5M14 10V5M14 10l6-6M10 14H5M10 14v5M10 14l-6 6" }) }));
    const pdfIcon = (_jsxs("svg", { className: "w-7 h-7", fill: "none", viewBox: "0 0 24 24", stroke: "currentColor", strokeWidth: 1.75, children: [_jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", d: "M14 3H7a2 2 0 00-2 2v14a2 2 0 002 2h10a2 2 0 002-2V8l-5-5z" }), _jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", d: "M14 3v5h5M9 13h6M9 17h6" })] }));
    const toolbarBtnClass = "w-8 h-8 rounded-md flex items-center justify-center text-stone-500 hover:text-stone-900 hover:bg-stone-200/70 disabled:opacity-30 disabled:hover:bg-transparent transition-colors";
    ...
    const previewToolbar = (_jsxs("div", { className: "flex items-center justify-between mb-2", children: [_jsx("span", { className: "text-xs font-medium text-stone-500", children: t("pdfPreview.preview") }), _jsxs("div", { className: "flex items-center gap-1", children: [!isMobile && (_jsx("button", { type: "button", onClick: () => setExpanded((v) => !v), title: expanded ? t("pdf.collapse") : t("pdf.expand"), "aria-label": expanded ? t("pdf.collapse") : t("pdf.expand"), "aria-pressed": expanded, className: toolbarBtnClass, children: expanded ? collapseIcon : expandIcon })), _jsx("button", { type: "button", onClick: openFullscreen, disabled: !previewUrl, title: t("pdf.openFullscreen"), "aria-label": t("pdf.openFullscreen"), className: toolbarBtnClass, children: fullscreenIcon })] })] }));
    const generatingOverlay = generating && (_jsx("div", { className: "absolute inset-0 flex items-center justify-center bg-white/60 rounded-lg", children: _jsxs("div", { className: "flex items-center gap-2 text-sm text-stone-500", children: [_jsx("span", { className: "w-4 h-4 border-2 border-stone-300 border-t-stone-600 rounded-full animate-spin" }), t("pdfPreview.generating")] }) }));
    const previewContent = (_jsx("div", { className: "flex-1 min-h-0 flex flex-col", children: selectedList.length === 0 ? (_jsx("div", { className: "flex-1 flex items-center justify-center text-sm text-stone-400 text-center px-4", children: t("pdfPreview.noneSelected") })) : isMobile ? (
        // Phones: inline PDF iframes are unreliable (iOS Safari shows only page 1), so offer a button instead.
        _jsxs("div", { className: "relative flex-1 min-h-[12rem] flex flex-col items-center justify-center gap-2 px-4", children: [_jsxs("button", { type: "button", onClick: openFullscreen, disabled: !previewUrl || generating, className: "inline-flex items-center gap-3 px-5 py-3.5 rounded-xl bg-stone-950 text-white text-sm font-medium disabled:opacity-40 hover:bg-stone-800 transition-colors", children: [pdfIcon, t("pdf.previewOnPhone"), fullscreenIcon] }), _jsx("p", { className: "text-xs text-stone-400 text-center", children: t("pdf.previewOnPhoneHint") }), generatingOverlay] })) : (_jsxs(_Fragment, { children: [previewToolbar, _jsxs("div", { className: "relative flex-1 min-h-0", children: [previewUrl && (_jsx("iframe", { title: t("pdfPreview.preview"), src: previewUrl, className: "w-full h-full rounded-lg border border-stone-200 bg-white" })), generatingOverlay] })] })) }));
