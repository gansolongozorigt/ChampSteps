...
import { createPromoCode, listPromoCodes, seedPromoCodes, togglePromoCode, } from "../lib/firebase";
...
function PromoSection() {
    ...
    async function handleToggle(code, currentActive) {
