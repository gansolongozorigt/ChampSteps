        ...
        async function loadTeachers() {
            ...
            for (const uid of teacherIds) {
                try {
                    ...
                    if (doc)
                        results.push({ uid, name: doc.displayName ?? t("coach.defaultName") });
                }
                catch {
                    // ignore
                }
