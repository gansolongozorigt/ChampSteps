...
function Dashboard() {
    ...
    return (_jsxs("div", { className: "flex flex-col h-screen bg-stone-100 font-sans", children: [_jsxs("header", { className: "sticky top-0 z-40 bg-stone-950 print:hidden", children: [_jsxs("div", { className: "px-4 py-2.5 flex items-center justify-between", children: [_jsxs("div", { className: "flex items-center gap-2", children: [_jsxs("svg", { width: "22", height: "22", viewBox: "0 0 48 48", fill: "none", "aria-hidden": "true", children: [_jsxs("defs", { children: [_jsxs("linearGradient", { id: "hg1", x1: "0", y1: "0", x2: "0", y2: "1", children: [_jsx("stop", { offset: "0%", stopColor: "#d97706", stopOpacity: "0.25" }), _jsx("stop", { offset: "100%", stopColor: "#d97706", stopOpacity: "0.12" })] }), _jsxs("linearGradient", { id: "hg2", x1: "0", y1: "0", x2: "0", y2: "1", children: [_jsx("stop", { offset: "0%", stopColor: "#d97706", stopOpacity: "0.65" }), _jsx("stop", { offset: "100%", stopColor: "#b45309", stopOpacity: "0.5" })] }), _jsxs("linearGradient", { id: "hg3", x1: "0", y1: "0", x2: "0", y2: "1", children: [_jsx("stop", { offset: "0%", stopColor: "#fbbf24" }), _jsx("stop", { offset: "100%", stopColor: "#92400e" })] })] }), _jsx("rect", { x: "4", y: "32", width: "10", height: "12", rx: "2.5", fill: "url(#hg1)" }), _jsx("rect", { x: "17", y: "22", width: "10", height: "22", rx: "2.5", fill: "url(#hg2)" }), _jsx("rect", { x: "30", y: "10", width: "10", height: "34", rx: "2.5", fill: "url(#hg3)" }), _jsx("circle", { cx: "35", cy: "7", r: "5.5", fill: "white", fillOpacity: "0.1" }), _jsx("path", { d: "M35 4.2L36.1 6.7H38.7L36.6 8.2L37.4 10.8L35 9.3L32.6 10.8L33.4 8.2L31.3 6.7H33.9Z", fill: "#fbbf24" })] }), _jsxs("span", { className: "text-[15px] font-bold tracking-tight leading-none", children: [_jsx("span", { className: "text-white", children: "Champ" }), _jsx("span", { style: { background: "linear-gradient(135deg,#fbbf24 0%,#d97706 100%)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent", backgroundClip: "text" }, children: "Step" })] }), _jsx("span", { className: `text-[9px] font-semibold uppercase tracking-wider px-2 py-0.5 rounded border ${subscription === "family" ? "bg-blue-950 text-blue-300 border-blue-700" :
                                ...
                                }) }), _jsx("div", { className: "px-3 pb-4 border-t border-stone-800 pt-3 mt-3", children: isPremium ? (_jsxs("div", { className: "rounded-lg bg-stone-900 border border-stone-800 px-3 py-2.5", children: [_jsx("p", { className: "text-[10px] font-semibold text-amber-400 mb-1", children: subscription === "family" ? `★ ${t("sub.tierNames.family")}` : subscription === "master" ? `★ ${t("sub.tierNames.master")}` : `★ ${t("sub.tierNames.coach")}` }), _jsx("p", { className: "text-[10px] text-stone-500", children: "\u0425\u044F\u0437\u0433\u0430\u0430\u0440\u0433\u04AF\u0439 \u0430\u043C\u0436\u0438\u043B\u0442 \u00B7 PDF \u00B7 AI" })] })) : (_jsxs("div", { className: "rounded-lg bg-stone-900 border border-stone-800 px-3 py-2.5", children: [_jsx("div", { className: "flex items-center justify-between mb-1.5", children: _jsxs("span", { className: "text-[10px] text-stone-400 font-medium", children: [t("sub.tierNames.free").toUpperCase(), " \u00B7 ", achCount, "/", maxAch] }) }), _jsx("div", { className: "h-1 bg-stone-800 rounded-full overflow-hidden mb-2", children: _jsx("div", { className: `h-full rounded-full transition-all ${showLimitWarning ? "bg-gradient-to-r from-amber-500 to-red-500" : "bg-stone-600"}`, style: { width: `${Math.min(100, (achCount / maxAch) * 100)}%` } }) }), _jsx("button", { onClick: () => setShowSubscription(true), className: "w-full text-[11px] font-bold py-1.5 rounded-md bg-amber-500 text-stone-950 hover:bg-amber-400 transition-colors", children: "\u2B06 Upgrade" })] })) })] }), _jsxs("main", { ref: mainRef, className: "flex-1 overflow-y-auto pb-24 md:pb-6 print:p-0", children: [user?.role === "teacher" && (_jsxs("div", { className: "bg-stone-900 px-4 py-2 text-center text-[11px] text-amber-400 print:hidden", children: ["\uD83C\uDFEB ", t("status.teacherMode")] })), activeSection === "achievements" && (_jsx(TimelineDashboard, { child: child, achievements: achievements, onAddClick: () => setShowForm(true), onEditProfile: () => setShowProfile(true), onEditAchievement: (a) => setEditingAchievement(a), onDeleteAchievement: handleDeleteAchievement })), activeSection === "practice" && (_jsxs("div", { className: "px-4 py-6 max-w-3xl mx-auto", children: [_jsx(SectionHeader, { title: t("practice.title") || "Бэлтгэлийн тэмдэглэл", subtitle: child.name }), _jsx(PracticeLogSection, { childId: child.childId, logs: practiceLogs, onAdd: handleAddPracticeLog, onDelete: handleDeletePracticeLog })] })), activeSection === "reflection" && (_jsxs("div", { className: "px-4 py-6 max-w-3xl mx-auto", children: [_jsx(SectionHeader, { title: t("reflection.title") || "Хүүхдийн сэтгэлзүйн тэмдэглэл", subtitle: child.name }), user?.role === "parent" ? (_jsx(ReflectionSection, { childId: child.childId, reflections: reflections, onAdd: handleAddReflection, onDelete: handleDeleteReflection })) : (_jsx("div", { className: "text-center py-12 text-stone-400 text-sm", children: t("reflection.parentOnly") }))] })), activeSection === "coach" && (_jsxs("div", { className: "px-4 py-6 max-w-3xl mx-auto", children: [_jsx(SectionHeader, { title: t("invite.parent.heading") || "Багштай холбогдох", subtitle: child.name }), _jsxs("div", { className: "grid gap-4", children: [user?.role === "teacher" && _jsx(TeacherInvitePanel, { teacherId: user.uid, teacherName: user.displayName, onCreateCode: createInviteCode }), user?.role === "parent" && child && _jsx(ParentLinkPanel, { childId: child.childId, childName: child.name, onUseCode: useInviteCode })] })] })), activeSection === "pdf" && (_jsxs("div", { className: "px-4 py-6 max-w-xl mx-auto", children: [_jsx(SectionHeader, { title: "PDF", subtitle: child.name }), _jsxs("div", { className: "bg-white rounded-2xl shadow-sm border border-stone-200 overflow-hidden", children: [_jsx("div", { className: "px-4 py-3 border-b border-stone-100", children: _jsx("p", { className: "text-[11px] text-stone-500", children: t("pdf.downloadSubtitle", { name: child.name }) }) }), _jsx("div", { className: "divide-y divide-stone-100", children: ([
