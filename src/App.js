...
function Dashboard() {
    ...
    if (loadingChildren)
        return _jsx(FullScreenLoader, {});
    if (!child) {
        return (_jsx("div", { className: "flex min-h-screen items-center justify-center bg-stone-50", children: _jsx("p", { className: "text-stone-500", children: t("status.childNotFound") }) }));
    }
    ...
    return (_jsxs("div", { className: "flex flex-col h-screen bg-stone-100 font-sans", children: [_jsxs("header", { className: "sticky top-0 z-40 bg-stone-950 print:hidden cs-app-header", children: [_jsxs("div", { className: "px-4 py-2.5 flex items-center justify-between", children: [_jsxs("div", { className: "flex items-center gap-2", children: [_jsxs("svg", { width: "22", height: "22", viewBox: "0 0 48 48", fill: "none", "aria-hidden": "true", children: [_jsxs("defs", { children: [_jsxs("linearGradient", { id: "hg1", x1: "0", y1: "0", x2: "0", y2: "1", children: [_jsx("stop", { offset: "0%", stopColor: "#d97706", stopOpacity: "0.25" }), _jsx("stop", { offset: "100%", stopColor: "#d97706", stopOpacity: "0.12" })] }), _jsxs("linearGradient", { id: "hg2", x1: "0", y1: "0", x2: "0", y2: "1", children: [_jsx("stop", { offset: "0%", stopColor: "#d97706", stopOpacity: "0.65" }), _jsx("stop", { offset: "100%", stopColor: "#b45309", stopOpacity: "0.5" })] }), _jsxs("linearGradient", { id: "hg3", x1: "0", y1: "0", x2: "0", y2: "1", children: [_jsx("stop", { offset: "0%", stopColor: "#fbbf24" }), _jsx("stop", { offset: "100%", stopColor: "#92400e" })] })] }), _jsx("rect", { x: "4", y: "32", width: "10", height: "12", rx: "2.5", fill: "url(#hg1)" }), _jsx("rect", { x: "17", y: "22", width: "10", height: "22", rx: "2.5", fill: "url(#hg2)" }), _jsx("rect", { x: "30", y: "10", width: "10", height: "34", rx: "2.5", fill: "url(#hg3)" }), _jsx("circle", { cx: "35", cy: "7", r: "5.5", fill: "white", fillOpacity: "0.1" }), _jsx("path", { d: "M35 4.2L36.1 6.7H38.7L36.6 8.2L37.4 10.8L35 9.3L32.6 10.8L33.4 8.2L31.3 6.7H33.9Z", fill: "#fbbf24" })] }), _jsxs("span", { className: "text-[15px] font-bold tracking-tight leading-none", children: [_jsx("span", { className: "text-white", children: "Champ" }), _jsx("span", { style: { background: "linear-gradient(135deg,#fbbf24 0%,#d97706 100%)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent", backgroundClip: "text" }, children: "Step" })] }), _jsx("span", { className: `text-[9px] font-semibold uppercase tracking-wider px-2 py-0.5 rounded border ${subscription === "family" ? "bg-blue-950 text-blue-300 border-blue-700" :
                                            ...
                                            subscription === "master" ? t("sub.tierNames.master").toUpperCase() :
                                                subscription === "coach" ? `★ ${t("sub.tierNames.coach").toUpperCase()}` : t("sub.tierNames.free").toUpperCase() })] }), _jsxs("div", { className: "flex items-center gap-1.5", children: [_jsx(LanguageChip, {}), _jsx("button", { onClick: () => setShowSubscription(true), className: "text-[11px] font-medium px-2.5 py-1.5 rounded-md bg-stone-800 text-amber-400 border border-amber-800/50 hover:bg-stone-700 active:scale-95 transition-all", title: t("nav.subscription"), children: "\u2605" }), _jsxs("div", { ref: userMenuRef, className: "relative", children: [_jsx("button", { onClick: () => setShowUserMenu(!showUserMenu), className: "relative w-7 h-7 rounded-full overflow-visible border-2 border-stone-700 hover:border-amber-500 transition-colors shrink-0", children: _jsx("div", { className: "w-full h-full rounded-full overflow-hidden", children: child.avatarUrl ? _jsx("img", { src: child.avatarUrl, alt: child.name, className: "w-full h-full object-cover" }) : _jsx("div", { className: "w-full h-full bg-amber-600 flex items-center justify-center text-[11px] font-bold text-white", children: child.name.slice(0, 1).toUpperCase() }) }) }), showUserMenu && (_jsxs("div", { className: "absolute right-0 top-full mt-1.5 w-52 rounded-xl bg-stone-900 border border-stone-800 shadow-xl z-50 overflow-hidden", children: [user?.email && (_jsx("div", { className: "px-3 py-2.5 border-b border-stone-800", children: _jsx("p", { className: "text-[10px] text-stone-500 truncate", children: user.email }) })), _jsx("button", { onClick: () => { setShowUserMenu(false); setShowProfile(true); }, className: "w-full text-left px-3 py-2.5 text-[12px] text-stone-300 hover:bg-stone-800 transition-colors", children: t("profile.edit") }), _jsx("button", { onClick: () => { setShowUserMenu(false); setActiveSection("about"); }, className: "w-full text-left px-3 py-2.5 text-[12px] text-stone-300 hover:bg-stone-800 transition-colors", children: t("nav.about") }), _jsx("button", { onClick: () => { setShowUserMenu(false); setActiveSection("terms"); }, className: "w-full text-left px-3 py-2.5 text-[12px] text-stone-300 hover:bg-stone-800 transition-colors", children: t("nav.terms") }), user?.email === "gansolongozorigt7@gmail.com" && (_jsx("button", { onClick: () => { setShowUserMenu(false); setShowAdmin(true); }, className: "w-full text-left px-3 py-2.5 text-[12px] text-amber-400 hover:bg-stone-800 transition-colors", children: "\u2699 Admin" })), _jsx("button", { onClick: () => { setShowUserMenu(false); handleSignOut(); }, className: "w-full text-left px-3 py-2.5 text-[12px] text-red-400 hover:bg-stone-800 transition-colors border-t border-stone-800", children: t("auth.signOut") })] }))] })] })] }), _jsxs("div", { className: "md:hidden bg-stone-900 px-2 pb-2 flex items-center gap-1.5 overflow-x-auto scrollbar-hide border-b border-stone-800", children: [children.map((c, i) => (_jsxs("button", { onClick: () => setActiveChildIdx(i), className: `flex items-center gap-1 text-[10px] font-medium px-2 py-1 rounded-md whitespace-nowrap shrink-0 transition-all ${i === activeChildIdx ? "bg-amber-600 text-white" : "bg-stone-800 text-stone-400 hover:bg-stone-700 hover:text-stone-200"}`, children: [c.avatarUrl ? _jsx("img", { src: c.avatarUrl, alt: c.name, className: "w-4 h-4 rounded-full object-cover shrink-0" }) : _jsx("span", { className: "w-4 h-4 rounded-full bg-stone-600 text-[8px] font-bold text-white flex items-center justify-center shrink-0", children: c.name.slice(0, 1).toUpperCase() }), _jsx("span", { className: "max-w-[48px] truncate", children: c.name.length > 6 ? c.name.slice(0, 6) + "…" : c.name })] }, c.childId))), canAddChild && (_jsx("button", { onClick: () => setShowAddChild(true), className: "flex items-center justify-center text-[13px] w-7 h-7 rounded-md shrink-0 text-stone-400 border border-dashed border-stone-700 hover:border-stone-500 hover:text-stone-300 transition-colors", title: t("children.addChild"), children: "+" }))] })] }), !isFirebaseConfigured && (_jsxs("div", { className: "bg-amber-100 px-4 py-2 text-center text-[11px] text-amber-800 print:hidden", children: ["\u26A0\uFE0F ", t("status.offlineBanner")] })), _jsxs("div", { className: "flex flex-col md:flex-row flex-1 min-h-0 overflow-hidden", children: [_jsxs("aside", { className: "hidden md:flex flex-col w-56 bg-stone-950 border-r border-stone-800 shrink-0 overflow-y-auto cs-app-sidebar", children: [_jsxs("div", { className: "px-3 pt-4 pb-3 border-b border-stone-800", children: [_jsx("p", { className: "text-[9px] font-semibold uppercase tracking-widest text-stone-600 mb-2", children: t("children.title") }), _jsxs("div", { className: "space-y-1", children: [children.map((c, i) => (_jsxs("button", { onClick: () => setActiveChildIdx(i), className: `w-full flex items-center gap-2 px-2.5 py-2 rounded-lg text-left transition-all ${i === activeChildIdx ? "bg-amber-600 text-white" : "text-stone-400 hover:bg-stone-800 hover:text-stone-200"}`, children: [c.avatarUrl ? _jsx("img", { src: c.avatarUrl, alt: c.name, className: "w-6 h-6 rounded-full object-cover shrink-0" }) : _jsx("span", { className: "w-6 h-6 rounded-full bg-stone-700 text-[9px] font-bold text-stone-300 flex items-center justify-center shrink-0", children: c.name.slice(0, 1).toUpperCase() }), _jsx("span", { className: "text-[12px] font-medium truncate", children: c.name })] }, c.childId))), canAddChild && (_jsxs("button", { onClick: () => setShowAddChild(true), className: "w-full flex items-center gap-2 px-2.5 py-2 rounded-lg text-stone-600 border border-dashed border-stone-800 hover:border-stone-600 hover:text-stone-400 transition-colors text-[11px]", children: ["+ ", t("children.addChild")] }))] })] }), _jsx("nav", { className: "px-3 py-3 flex-1", children: navItems.map((item) => {
                                    ...
                                    return (_jsxs("button", { onClick: () => setActiveSection(item.id), className: `w-full flex items-center gap-3 px-2.5 py-2.5 rounded-lg mb-0.5 text-left transition-all ${active ? colors[item.id] : "text-stone-500 hover:bg-stone-800 hover:text-stone-300 hover:translate-x-1"}`, children: [_jsx("span", { className: "w-5 h-5 flex items-center justify-center shrink-0", children: item.icon }), _jsx("span", { className: "text-[12px] font-medium", children: item.label })] }, item.id));
                                }) }), _jsx("div", { className: "px-3 pb-4 border-t border-stone-800 pt-3 mt-3", children: isPremium ? (_jsxs("div", { className: "rounded-lg bg-stone-900 border border-stone-800 px-3 py-2.5", children: [_jsx("p", { className: "text-[10px] font-semibold text-amber-400 mb-1", children: subscription === "family" ? `★ ${t("sub.tierNames.family")}` : subscription === "master" ? `★ ${t("sub.tierNames.master")}` : `★ ${t("sub.tierNames.coach")}` }), _jsx("p", { className: "text-[10px] text-stone-500", children: t("sub.premiumFeatures") })] })) : (_jsxs("div", { className: "rounded-lg bg-stone-900 border border-stone-800 px-3 py-2.5", children: [_jsx("div", { className: "flex items-center justify-between mb-1.5", children: _jsxs("span", { className: "text-[10px] text-stone-400 font-medium", children: [t("sub.tierNames.free").toUpperCase(), " \u00B7 ", achCount, "/", maxAch] }) }), _jsx("div", { className: "h-1 bg-stone-800 rounded-full overflow-hidden mb-2", children: _jsx("div", { className: `h-full rounded-full transition-all ${showLimitWarning ? "bg-gradient-to-r from-amber-500 to-red-500" : "bg-stone-600"}`, style: { width: `${Math.min(100, (achCount / maxAch) * 100)}%` } }) }), _jsx("button", { onClick: () => setShowSubscription(true), className: "w-full text-[11px] font-bold py-1.5 rounded-md bg-amber-500 text-stone-950 hover:bg-amber-400 transition-colors", children: t("sub.upgrade") })] })) })] }), _jsxs("main", { ref: mainRef, className: "flex-1 overflow-y-auto pb-24 md:pb-6 print:p-0", children: [user?.role === "teacher" && (_jsxs("div", { className: "bg-stone-900 px-4 py-2 text-center text-[11px] text-amber-400 print:hidden", children: ["\uD83C\uDFEB ", t("status.teacherMode")] })), _jsxs("div", { className: "cs-section-in", children: [activeSection === "achievements" && (_jsx(TimelineDashboard, { child: child, achievements: achievements, loading: loadingAch && isFirebaseConfigured, onAddClick: () => setShowForm(true), onEditProfile: () => setShowProfile(true), onEditAchievement: (a) => setEditingAchievement(a), onDeleteAchievement: handleDeleteAchievement })), activeSection === "practice" && (_jsxs("div", { className: "px-4 py-6 max-w-3xl mx-auto", children: [_jsx(SectionHeader, { title: t("practice.title"), subtitle: child.name }), _jsx(PracticeLogSection, { childId: child.childId, logs: practiceLogs, onAdd: handleAddPracticeLog, onDelete: handleDeletePracticeLog })] })), activeSection === "reflection" && (_jsxs("div", { className: "px-4 py-6 max-w-3xl mx-auto", children: [_jsx(SectionHeader, { title: t("reflection.title"), subtitle: child.name }), user?.role === "parent" ? (_jsx(ReflectionSection, { childId: child.childId, reflections: reflections, onAdd: handleAddReflection, onDelete: handleDeleteReflection })) : (_jsx("div", { className: "text-center py-12 text-stone-400 text-sm", children: t("reflection.parentOnly") }))] })), activeSection === "coach" && (_jsxs("div", { className: "px-4 py-6 max-w-3xl mx-auto", children: [_jsx(SectionHeader, { title: t("invite.parent.heading"), subtitle: child.name }), _jsxs("div", { className: "grid gap-4", children: [user?.role === "teacher" && _jsx(TeacherInvitePanel, { teacherId: user.uid, teacherName: user.displayName, onCreateCode: createInviteCode }), user?.role === "parent" && child && _jsx(ParentLinkPanel, { childId: child.childId, childName: child.name, onUseCode: useInviteCode })] })] })), activeSection === "about" && (_jsx("div", { className: "px-4 py-6 max-w-2xl mx-auto", children: _jsx(AboutPage, {}) })), activeSection === "terms" && (_jsx("div", { className: "px-4 py-6 max-w-2xl mx-auto", children: _jsx(TermsPage, {}) })), activeSection === "pdf" && (_jsxs("div", { className: "px-4 py-6 max-w-xl mx-auto", children: [_jsx(SectionHeader, { title: "PDF", subtitle: child.name }), _jsxs("div", { className: "bg-white rounded-2xl shadow-sm border border-stone-200 overflow-hidden", children: [_jsx("div", { className: "px-4 py-3 border-b border-stone-100", children: _jsx("p", { className: "text-[11px] text-stone-500", children: t("pdf.downloadSubtitle", { name: child.name }) }) }), _jsx("div", { className: "divide-y divide-stone-100", children: ([
                            ...
                            const active = activeSection === item.id;
                            const colors = { achievements: "text-amber-500", practice: "text-blue-500", reflection: "text-rose-500", coach: "text-emerald-500", pdf: "text-violet-500", about: "text-teal-500", terms: "text-slate-400" };
                            const lines = { achievements: "bg-amber-500", practice: "bg-blue-500", reflection: "bg-rose-500", coach: "bg-emerald-500", pdf: "bg-violet-500", about: "bg-teal-500", terms: "bg-slate-400" };
                        ...
                        }) })] }), activeSection === "achievements" && (_jsx("button", { type: "button", onClick: () => setShowForm(true), "aria-label": t("app.addAchievement"), className: "group fixed z-30 bg-stone-950 text-white rounded-full shadow-lg shadow-stone-900/30 hover:bg-stone-800 hover:scale-105 active:scale-95 transition-all print:hidden flex items-center justify-center md:bottom-6 md:right-6", style: { bottom: "calc(env(safe-area-inset-bottom) + 72px)", right: 16, width: 52, height: 52 }, children: _jsx("svg", { className: "w-6 h-6 transition-transform duration-300 group-hover:rotate-90", fill: "none", viewBox: "0 0 24 24", stroke: "currentColor", strokeWidth: 2.5, children: _jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", d: "M12 4.5v15m7.5-7.5h-15" }) }) })), showForm && (_jsx("div", { className: "fixed inset-0 z-50 flex items-end justify-center bg-stone-900/50 backdrop-blur-sm p-2 sm:items-center sm:p-4 print:hidden cs-backdrop-in", onClick: () => setShowForm(false), children: _jsx("div", { onClick: (e) => e.stopPropagation(), className: "w-full max-w-2xl cs-panel-in", children: _jsx(AddAchievementForm, { childId: child.childId, childName: child.name, onCancel: () => setShowForm(false), onSubmit: handleAddAchievement }) }) })), editingAchievement && (_jsx("div", { className: "fixed inset-0 z-50 flex items-end justify-center bg-stone-900/50 backdrop-blur-sm p-2 sm:items-center sm:p-4 print:hidden cs-backdrop-in", onClick: () => setEditingAchievement(null), children: _jsx("div", { onClick: (e) => e.stopPropagation(), className: "w-full max-w-2xl cs-panel-in", children: _jsx(AddAchievementForm, { childId: child.childId, childName: child.name, initialDraft: editingAchievement, onCancel: () => setEditingAchievement(null), onSubmit: async (draft) => {
                            if (isFirebaseConfigured) {
                                try {
